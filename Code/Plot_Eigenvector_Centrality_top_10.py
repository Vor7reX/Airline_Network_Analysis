...
# Top ten nodes
nx.draw_networkx_nodes(
    top_10_G, pos, node_size=[eigenvector_centrality[node] * 6000 for node in top_10_G.nodes()],
...
# Edges
nx.draw_networkx_edges(top_10_G, pos, edgelist=top_edges, edge_color='#6a0dad', alpha=0.9, arrows=False, ax=ax)

# Title
plt.title('Flight Route Network - Only Top 10 Airports by Eigenvector Centrality')
plt.xlabel('Longitude')
plt.ylabel('Latitude')

# Save the plot as a png
plt.savefig('Eigenvector_centrality_onlytopnodes.png', dpi=600)
plt.close()
#########################################################################################
